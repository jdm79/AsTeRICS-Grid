    ...
    <div class="overflow-content">
        ...
        <div class="srow content spaced" v-if="show">
            <div class="srow" style="margin-bottom: 0">
                ...
                <div v-if="saveSuccess" style="padding-top: 1.7em">
                    <i class="fas fa-check" style="color: green"></i> <span>{{ $t('allChangesSaved') }}</span>
                </div>
            </div>
            <div class="srow">
                ...
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        >
                            ...
                            <option
                                v-for="lang in allLanguages.filter((langObject) =>
                                    appLanguages.includes(langObject.code)
                                )"
                                :value="lang.code"
                            >
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        <label class="three columns" for="unlockPass">{{
                            $t('passcodeForUnlockingUserInterface')
                        }}</label>
                        <input
                            class="five columns"
                            id="unlockPass"
            ...
            <div class="srow">
                <accordion :acc-label="$t('advancedGeneralSettings')" class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        <input
                            type="text"
                            id="externalSpeechUrl"
                            class="seven columns"
                            v-model="appSettings.externalSpeechServiceUrl"
                            @input="saveAppSettings(reloadVoices)"
                            placeholder="http://localhost:5555"
                        />
                        <span class="spaced" v-show="validSpeechServiceUrl === undefined"
                            ><i class="fas fa-spinner fa-spin"
                        /></span>
                        <span
                            class="spaced"
                            v-show="validSpeechServiceUrl"
                            style="color: green"
                            :title="$t('urlIsValid')"
                        ...
                        <span
                            class="spaced"
                            v-show="validSpeechServiceUrl === false"
                            style="color: red"
                            :title="$t('urlIsInvalid')"
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        <select
                            class="five columns mb-2"
                            id="contentLang"
                            v-model="userSettingsLocal.contentLang"
                            @change="saveUserSettingsLocal()"
                        >
                        ...
                        <div class="four columns">
                            <input
                                id="selectAllLanguages"
                                type="checkbox"
                                v-model="selectAllLanguages"
                                @change="showAllLangsChanged()"
                            />
                ...
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        <select
                            id="inVoice"
                            class="five columns mb-2"
                            v-model="userSettingsLocal.voiceConfig.preferredVoice"
                            @change="
                                resetVoiceProps();
                        ...
                        <div class="four columns">
                            <input
                                id="selectAllVoices"
                                type="checkbox"
                                v-model="selectAllVoices"
                                @change="showAllVoicesChanged()"
                            />
                        ...
                        <accordion :acc-label="$t('advancedVoiceSettings')" class="eleven columns">
                            <div v-if="userSettingsLocal.voiceConfig.preferredVoice">
                                <slider-input
                                    ...
                                    step="0.1"
                                    decimals="1"
                                    v-model.number="userSettingsLocal.voiceConfig.voicePitch"
                                    @change="saveUserSettingsLocal()"
                                />
                                <slider-input
                                    :label="$t('voiceRate')"
                                    ...
                                    step="0.1"
                                    decimals="1"
                                    v-model.number="userSettingsLocal.voiceConfig.voiceRate"
                                    @change="saveUserSettingsLocal()"
                                />
                            </div>
                            <div class="srow">
                                ...
                                <select
                                    id="inVoice2"
                                    class="five columns mb-2"
                                    v-model="userSettingsLocal.voiceConfig.secondVoice"
                                    @change="saveUserSettingsLocal()"
                                >
                                ...
                                <button
                                    id="testVoice2"
                                    class="three columns"
                                    :disabled="!userSettingsLocal.voiceConfig.secondVoice"
                                    @click="speechService.testSpeak(userSettingsLocal.voiceConfig.secondVoice)"
                                >
                                    {{ $t('test') }}
                                </button>
                            </div>
                            <div class="srow">
                                <input
                                    id="voiceLangIsTextLang"
                                    type="checkbox"
                                    v-model="userSettingsLocal.voiceConfig.voiceLangIsTextLang"
                                    @change="saveUserSettingsLocal()"
                                />
                                <label for="voiceLangIsTextLang">{{
                                    $t('linkVoiceLanguageToTranslationLanguageOfSpokenText')
                                }}</label>
                            </div>
                            <div
                                class="srow"
                                v-show="!!speechService.getExternalVoice(userSettingsLocal.voiceConfig.preferredVoice)"
                            >
                                <button
                                    @click="cacheAll()"
                                    :disabled="
                                        externalVoiceCacheProgress !== undefined && externalVoiceCacheProgress !== 100
                                    "
                                >
                                    {{ $t('cacheAllTextsOfCurrentConfigurationExternalVoice') }}
                                </button>
                                <span v-show="externalVoiceCacheProgress !== undefined">
                                    ... {{ externalVoiceCacheProgress }}%</span
                                >
                            </div>
                        </accordion>
                    </div>
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        <input
                            id="elemColor"
                            v-model="metadata.colorConfig.elementBackgroundColor"
                            class="five columns"
                            type="color"
                            @change="saveMetadata()"
                        />
                    ...
                    <div class="srow">
                        <label class="three columns" for="elemBorderColor">
                            <span>{{ $t('defaultGridElementBorderColor') }}</span>
                        </label>
                        <input
                            id="elemBorderColor"
                            v-model="metadata.colorConfig.elementBorderColor"
                            class="five columns"
                            type="color"
                            @change="saveMetadata()"
                        />
                        <button
                            class="three columns"
                            @click="
                                metadata.colorConfig.elementBorderColor = constants.DEFAULT_ELEMENT_BORDER_COLOR;
                                saveMetadata();
                            "
                        >
                            {{ $t('reset') }}
                    ...
                    <div class="srow">
                        ...
                        <input
                            id="appColor"
                            v-model="metadata.colorConfig.gridBackgroundColor"
                            class="five columns"
                            type="color"
                            @change="saveMetadata()"
                        />
                        <button
                            class="three columns"
                            @click="
                                metadata.colorConfig.gridBackgroundColor = constants.DEFAULT_GRID_BACKGROUND_COLOR;
                                saveMetadata();
                            "
                        >
                            {{ $t('reset') }}
                    ...
                    <div class="srow">
                        ...
                        <select
                            id="colorScheme"
                            class="five columns"
                            v-model="metadata.colorConfig.activeColorScheme"
                            @change="saveMetadata()"
                        >
                            <option v-for="scheme in constants.DEFAULT_COLOR_SCHEMES" :value="scheme.name">
                    ...
                    <div class="srow">
                        <div class="five columns offset-by-three d-flex" style="height: 1.5em">
                            <div
                                class="flex-grow-1"
                                v-for="(color, index) in MetaData.getActiveColorScheme(metadata).colors"
                                :title="$t(MetaData.getActiveColorScheme(metadata).categories[index])"
                    ...
                    <div class="srow">
                        <input
                            id="colorSchemeActive"
                            type="checkbox"
                            v-model="metadata.colorConfig.colorSchemesActivated"
                            @change="saveMetadata()"
                        />
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <global-input-options
                        :input-config="metadata.inputConfig"
                        heading-tag="h4"
                        @change="saveMetadata()"
                        :hide-acoustic-feedback="true"
                    ></global-input-options>
                </div>
            </div>
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div class="srow">
                        ...
                        <select
                            id="convertText"
                            v-model="metadata.textConfig.convertMode"
                            class="five columns"
                            @change="saveMetadata()"
                        >
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div>
                        <input
                            id="activateARASAACGrammarAPI"
                            type="checkbox"
                            v-model="metadata.activateARASAACGrammarAPI"
                            @change="saveMetadata()"
                        />
                        <label for="activateARASAACGrammarAPI">
                            <i18n path="activateAutomaticGrammarCorrectionARASAACAPI" tag="span">
                                <template v-slot:availableLangs>
                                    <span>{{
                                        util.arrayToPrintable(arasaacService.getSupportedGrammarLangs(true))
                                    }}</span>
                                </template>
                            </i18n>
                        </label>
                    ...
                    <div>
                        ...
                        <i18n path="noteThatActivatingThisSendsSentencesToARASAACSeePrivacy" tag="span">
                            <template v-slot:link>
                                <a
                                    v-if="!i18nService.isCurrentAppLangDE()"
                                    target="_blank"
                                    href="app/privacy_en.html?back=settings#data-transfer"
                                    >{{ $t('privacyPolicy') }}</a
                                ><a
                                    v-if="i18nService.isCurrentAppLangDE()"
                                    target="_blank"
                                    href="app/privacy_de.html?back=settings#data-transfer"
                                    >{{ $t('privacyPolicy') }}</a
                                >
                            </template>
                        </i18n>
...
export default {
    ...
    methods: {
        ...
        async reloadVoices() {
            ...
            this.validSpeechServiceUrl = await speechServiceExternal.validateUrl(
                this.appSettings.externalSpeechServiceUrl
            );
        ...
        setVoiceTestText() {
            let voice = this.voices.filter(
                (voice) => voice.id === this.userSettingsLocal.voiceConfig.preferredVoice
            )[0];
